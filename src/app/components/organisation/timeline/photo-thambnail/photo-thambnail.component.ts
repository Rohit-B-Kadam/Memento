...
@Component({
  selector: 'app-photo-thambnail',
  templateUrl: './photo-thambnail.component.html',
  styleUrls: ['./photo-thambnail.component.scss']
})
export class PhotoThambnailComponent implements OnInit ,OnDestroy  {
